...
static const char *const yytname[] =
{
  ...
  "LLAVEIZQ", "LLAVEDER", "PUNTOYCOMA", "$accept", "programa", "bloque",
  "$@1", "instrucciones", "instruccion", YY_NULLPTR
};
...
#line 1104 "parser.tab.c"
  ...
  case 4: /* bloque: LLAVEIZQ $@1 instrucciones LLAVEDER  */
#line 53 "parser.y"
                                                         { salir_ambito(); }
#line 1110 "parser.tab.c"
    break;

  case 7: /* instruccion: INT ID PUNTOYCOMA  */
#line 62 "parser.y"
                                { agregar_local((yyvsp[-1].str)); }
#line 1116 "parser.tab.c"
    break;

  case 8: /* instruccion: ID PUNTOYCOMA  */
#line 63 "parser.y"
                                 {
                                    if (!buscar_local((yyvsp[-1].str)))
