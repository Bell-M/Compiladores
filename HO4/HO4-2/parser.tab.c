...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declaraciones = 9,              /* declaraciones  */
  YYSYMBOL_asignaciones = 10               /* asignaciones  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "INT", "IGUAL",
  "PUNTOYCOMA", "$accept", "programa", "declaraciones", "asignaciones", YY_NULLPTR
};
...
{
       6,     7,     1,     4,     5,     9,    10,    15,    11,    12,
      13,     0,     0,    17,    14,    16,     0,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* declaraciones: INT ID PUNTOYCOMA  */
#line 49 "parser.y"
                      { agregar_tipo((yyvsp[-1].str), 0); }
#line 1096 "parser.tab.c"
    break;

  case 4: /* declaraciones: declaraciones INT ID PUNTOYCOMA  */
#line 50 "parser.y"
                                    { agregar_tipo((yyvsp[-1].str), 0); }
#line 1102 "parser.tab.c"
    break;

  case 5: /* asignaciones: ID IGUAL ID PUNTOYCOMA  */
#line 54 "parser.y"
                           {
        if (!existe((yyvsp[-3].str)) || !existe((yyvsp[-1].str)))
            printf("Error: identificador no declarado\n");
        else if (buscar_tipo((yyvsp[-3].str)) != buscar_tipo((yyvsp[-1].str)))
            printf("Error: tipos incompatibles\n");
    }
#line 1113 "parser.tab.c"
    break;

  case 6: /* asignaciones: asignaciones ID IGUAL ID PUNTOYCOMA  */
#line 60 "parser.y"
                                        {
        if (!existe((yyvsp[-3].str)) || !existe((yyvsp[-1].str)))
            printf("Error: identificador no declarado\n");
